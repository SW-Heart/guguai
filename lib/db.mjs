...
function seedDefaults(handle) {
  ...
  // Keep the Grok Video row visible but disabled until its launch. Explicit admin changes are preserved.
  handle.prepare(`
    UPDATE model_controls
    SET user_visible = 1, enabled = 0, updated_at = :updatedAt
    WHERE model_id = 'grok-15' AND updated_by IS NULL AND version = 1
