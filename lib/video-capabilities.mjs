...
const modelCatalog = Object.freeze([
  ...
  // Veo 3.1 Fast：支持文生视频（TEXT）、参考图（REFERENCE）和首尾帧（FIRST&LAST）。
  Object.freeze({ id: VIDEO_MODEL_IDS.VEO, label: 'Veo 3.1 Fast', description: '支持首尾帧模式，固定8秒，速度快', profiles: Object.freeze({ TEXT: profiles.veoFastText, REFERENCE: profiles.veoFastReference, 'FIRST&LAST': profiles.veoFastFirstLast }) }),
