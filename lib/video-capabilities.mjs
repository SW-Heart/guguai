...
const autodlGugu10Pricing = Object.freeze({ currency: 'credit', amount: 1, unit: 'second' });
const autodlGugu10ReferenceLimits = Object.freeze({ image: 9, video: 0, audio: 3, total: 12 });
...
const profiles = Object.freeze({
  ...
  gugu10: Object.freeze({
    ...
    maxImages: 9,
    qualities: ['768p', '480p'],
    pricing: autodlGugu10Pricing,
    referenceLimits: autodlGugu10ReferenceLimits,
  }),
...
const modelCatalog = Object.freeze([
  ...
  Object.freeze({ id: VIDEO_MODEL_IDS.GROK_15, label: 'GuGu 2.0', description: '支持最多 9 张参考图片 + 3 段参考音频，1～15 秒视频生成', iconKey: 'grok', profiles: Object.freeze({ TEXT: profiles.gugu10, REFERENCE: profiles.gugu10 }) }),
...
export function publicVideoCapabilities() {
  return {
    ...
    routing: [
      ...
      { modelId: VIDEO_MODEL_IDS.GROK_15, label: 'GuGu 2.0', mode: 'TEXT|REFERENCE', durations: [...profiles.gugu10.durations], model: autodlWorkflowId, qualities: [...profiles.gugu10.qualities], pricing: autodlGugu10Pricing },
...
export function validateVideoRequest(input, referenceCount = 0) {
  ...
  const defaultDuration = [VIDEO_MODEL_IDS.VEO, VIDEO_MODEL_IDS.VEO_31].includes(modelId)
    ? 8
    : modelId === VIDEO_MODEL_IDS.GROK_15
      ? profiles.gugu10.defaultDuration
