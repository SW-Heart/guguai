...
const modelCatalog = Object.freeze([
  Object.freeze({ id: VIDEO_MODEL_IDS.GROK, label: 'Grok Video 1.5 Fast', profiles: Object.freeze({ TEXT: profiles.standard, REFERENCE: profiles.standard }) }),
  Object.freeze({ id: VIDEO_MODEL_IDS.GROK_15, label: 'Grok Video', availability: 'coming-soon', iconKey: 'grok', profiles: Object.freeze({ TEXT: profiles.grok15, REFERENCE: profiles.grok15 }) }),
  Object.freeze({ id: VIDEO_MODEL_IDS.VEO, label: 'Veo 3.1 Fast', profiles: Object.freeze({ TEXT: profiles.veoFastText, REFERENCE: profiles.veoFastReference, 'FIRST&LAST': profiles.veoFastFirstLast }) }),
  Object.freeze({ id: VIDEO_MODEL_IDS.OAI, label: 'Omni Flash', profiles: Object.freeze({ TEXT: profiles.oai, REFERENCE: profiles.oai }) }),
  Object.freeze({ id: VIDEO_MODEL_IDS.VEO_31, label: 'Veo 3.1', profiles: Object.freeze({ TEXT: profiles.veo31Text, REFERENCE: profiles.veo31Reference, 'FIRST&LAST': profiles.veo31FirstLast }) }),
...
export function publicVideoCapabilities() {
  return {
    ...
    routing: [
      { modelId: VIDEO_MODEL_IDS.GROK_15, label: 'Grok Video', mode: 'TEXT|REFERENCE', durations: [6, 12], model: oaiGrok15Model, qualities: ['480p', '720p'], pricing: oaiGrokPricing },
      { modelId: VIDEO_MODEL_IDS.GROK, label: 'Grok Video 1.5 Fast', mode: 'TEXT|REFERENCE', durations: [10, 20, 30], model: ttapiFastModel, qualities: ['480p', '720p'] },
      { modelId: VIDEO_MODEL_IDS.VEO, label: 'Veo 3.1 Fast', mode: 'TEXT|REFERENCE|FIRST&LAST', duration: 8, model: duomiVeoModel, qualities: ['720p'] },
      { modelId: VIDEO_MODEL_IDS.OAI, label: 'Omni Flash', mode: 'TEXT|REFERENCE|FIRST&LAST', duration: 10, model: oaiOmniFastModel },
