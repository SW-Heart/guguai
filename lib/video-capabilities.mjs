...
export function publicVideoCapabilities() {
  return {
    ...
    routing: [
      { modelId: VIDEO_MODEL_IDS.GROK, label: 'GuGu 1.5', mode: 'TEXT|REFERENCE', durations: [10, 15, 20, 30], qualities: ['480p', '720p'], pricing: ttapiFastPricing },
      ...
      { modelId: VIDEO_MODEL_IDS.MINIMAX_H3_15S, label: 'GuGu 2.0', mode: 'TEXT|REFERENCE', durations: [...profiles.minimaxH315s.durations], qualities: [...profiles.minimaxH315s.qualities], pricing: autodlMinimaxH315sPricing },
