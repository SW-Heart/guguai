...
import { checkModelRoutes, listModelRoutes, publicModelPrices, routePolicy, updateModelRoute, updateRoutePolicy } from './model-routes.mjs';
...
async function handleAuthorized(req, res, url, session, id) {
  ...
  if (url.pathname === '/api/admin/model-routes' && req.method === 'GET') {
    ...
    return sendJson(res, 200, { items, policies, prices: publicModelPrices() });
  }
