...
test('conversation assets use the updated cache chain',async()=>{
 ...
 const entries=[['public/index.html',['/app.js?v=321','/styles.css?v=262']],['public/app.js',['./drama-studio.js?v=131']],['public/drama-studio.js',['./features/drama/director-workspace.js?v=38']],['public/features/drama/director-workspace.js',["../agent/markdown.js?v=1", "../agent/image-bounds.js?v=1", "../../vendor/director/reference-canvas.js?v=28"]]];
