...
test('conversation assets use the updated cache chain',async()=>{
 ...
 const entries=[['public/index.html',['/app.js?v=349','/styles.css?v=265']],['public/app.js',['./drama-studio.js?v=142']],['public/drama-studio.js',['./features/drama/director-workspace.js?v=50','./features/drama/local-snapshot.js?v=1']],['public/features/drama/director-workspace.js',["./director-actions.js?v=8", "./local-snapshot.js?v=1", "../agent/markdown.js?v=1", "../agent/image-bounds.js?v=1", "../agent/frames.js?v=2", "../../vendor/director/reference-canvas.js?v=30"]]];
