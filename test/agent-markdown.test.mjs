...
test('conversation assets use the updated cache chain',async()=>{
 ...
 const entries=[['public/index.html',['/app.js?v=342','/styles.css?v=265']],['public/app.js',['./drama-studio.js?v=141']],['public/drama-studio.js',['./features/drama/director-workspace.js?v=45']],['public/features/drama/director-workspace.js',["./director-actions.js?v=8", "../agent/markdown.js?v=1", "../agent/image-bounds.js?v=1", "../../vendor/director/reference-canvas.js?v=29"]]];
