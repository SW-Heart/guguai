...
test('新入口刷新可打开，HTML 与模块缓存链路对应',()=>{
  ...
  assert.match(html,/app\.js\?v=348\b/);assert.doesNotMatch(html,/app\.js\?v=347\b/);assert.doesNotMatch(html,/app\.js\?v=346\b/);assert.doesNotMatch(html,/app\.js\?v=345\b/);assert.doesNotMatch(html,/app\.js\?v=344\b/);assert.doesNotMatch(html,/app\.js\?v=343\b/);assert.doesNotMatch(html,/app\.js\?v=342\b/);assert.doesNotMatch(html,/app\.js\?v=341\b/);assert.doesNotMatch(html,/app\.js\?v=340\b/);assert.doesNotMatch(html,/app\.js\?v=339\b/);assert.doesNotMatch(html,/app\.js\?v=338\b/);assert.doesNotMatch(html,/app\.js\?v=312\b/);
