...
test('mention entry cache chain is updated',()=>{
  for(const [file,url] of [['index.html','/app.js?v=341'],['app.js','./drama-studio.js?v=141'],['drama-studio.js','./features/drama/director-workspace.js?v=45'],['features/drama/director-workspace.js','./director-mentions.js?v=1']]){
