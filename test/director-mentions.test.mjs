...
test('mention entry cache chain is updated',()=>{
 for(const [file,url] of [['index.html','/app.js?v=348'],['app.js','./drama-studio.js?v=142'],['drama-studio.js','./features/drama/director-workspace.js?v=50'],['features/drama/director-workspace.js','./director-mentions.js?v=1']]){
