...
(() => {
  ...
  const userIdentity = user => {
    ...
    return nickname && phoneNumber ? `${esc(nickname)}（${esc(phoneNumber)}）` : esc(user?.username);
  };
