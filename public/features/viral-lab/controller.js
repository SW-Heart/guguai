...
export function createViralLab({ api, state, esc, toast, uploadAsset, loadFiles, loadTasks, scheduleTaskPoll, setCreditBalance, accountSnapshot, isAccountCurrent }) {
  ...
  function renderWorkbench() {
    ...
    if (!project) {
      root.innerHTML = `<div class="vl-home"><div class="vl-entry-grid"><button type="button" class="vl-entry" data-vl="create" data-vl-coming-soon="true" data-type="replica" aria-disabled="true" aria-label="爆款视频复刻，功能即将推出，敬请期待"><span class="vl-entry-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="m8 5 11 7-11 7V5Z"/><path d="M4 5v14"/></svg></span><span class="vl-entry-copy"><h2>爆款视频复刻</h2><p>保留镜头节奏，替换成你的商品和表达。</p></span><span class="vl-entry-action">敬请期待</span></button><button type="button" class="vl-entry vl-entry-outfit" data-vl="create" data-vl-coming-soon="true" data-type="outfit" aria-disabled="true" aria-label="电商换装复刻，功能即将推出，敬请期待"><span class="vl-entry-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M8 4h8l2 4-3 2v10H9V10L6 8l2-4Z"/><path d="M9 10h6"/></svg></span><span class="vl-entry-copy"><h2>电商换装复刻</h2><p>整理人物和服装，安排一条完整的换装表达。</p></span><span class="vl-entry-action">敬请期待</span></button><button type="button" class="vl-entry vl-entry-motion" data-vl="create-motion" data-vl-coming-soon="true" aria-disabled="true" aria-label="动作迁移，功能即将推出，敬请期待"><span class="vl-entry-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><circle cx="12" cy="5" r="2.5"/><path d="m8 10 4-2 4 2M10 9l-1 6 3 2 3-2-1-6M12 17v4M8 21l4-4 4 4"/></svg></span><span class="vl-entry-copy"><h2>动作迁移</h2><p>上传人物照片和动作视频，让照片中的人物跳起来。</p></span><span class="vl-entry-action">敬请期待</span></button></div><p data-vl-message role="status"></p></div>`;
      return;
    }
    const p = project;
